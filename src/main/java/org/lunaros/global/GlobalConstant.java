...
public class GlobalConstant {
    ...
    public static String BUILD_GENERATE_PATH= "/Lunaros_created_file";
    public static String NODATA_CONFIG_NAME = "Lunaros.agent.alive";
    ...
    public static String REGISTRY_EMAIL = "Lunaros@xxx.com";
    public static String SECRET_NAME_PREFIX = "Lunaros-";
    ...
    public static String LunarOS_MYSQL_HOST = "MYSQL_HOST";
    public static String LunarOS_MYSQL_PORT = "MYSQL_PORT";
    public static String LunarOS_MYSQL_DB = "MYSQL_DB";
    public static String LunarOS_MYSQL_USERNAME = "MYSQL_USERNAME";
    public static String LunarOS_MYSQL_PASSWORD = "MYSQL_PASSWORD";
    ...
    public static String UPDATE_JOB_CONTAINER = "pub.Lunaros.org/rolling-updater:v0.1";
