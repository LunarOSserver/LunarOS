package org.Lunaros.framework.engine.k8s.handler.impl;
...
import org.Lunaros.framework.api.consolemodel.deployment.VersionString;
...
import org.Lunaros.framework.engine.k8s.K8sPodSpecBuilder;
import org.Lunaros.framework.engine.k8s.handler.DeployResourceHandler;
import org.Lunaros.framework.engine.k8s.updater.DeploymentUpdateJob;
import org.Lunaros.framework.engine.k8s.util.KubeUtils;
import org.Lunaros.framework.engine.k8s.util.ModelFormatUtils;
import org.Lunaros.framework.engine.k8s.util.PodUtils;
import org.Lunaros.framework.engine.model.CustomObjectMapper;
import org.Lunaros.framework.engine.model.CustomYamlObjectMapper;
...
public class ReplicationControllerDeployHandler implements DeployResourceHandler<ReplicationController> {
    ...
    public ReplicationControllerDeployHandler(Deployment deployment, KubeUtils kubeUtils, String LunarosServer) {
        this.deployment = deployment;
        this.kubeUtils = kubeUtils;
        this.LunarosServer = LunarosServer;
    }
...
//        }
    ...
    private List<String> createArgs(long eventId, String jobName, int targetReplicas, int targetVersion) {
        ...
        args.add("--Lunaros-server=" + LunarosServer + "/api/deploy/updatejob");
        return args;
    }
