...
public class DeploymentDeployHandler implements DeployResourceHandler<Deployment> {
    private org.Lunaros.framework.api.model.deployment.Deployment deployment;
    private KubeUtils kubeUtils;
    private String LunarosServer;

    public DeploymentDeployHandler(org.Lunaros.framework.api.model.deployment.Deployment deployment, KubeUtils kubeUtils) {
        this.deployment = deployment;
        this.kubeUtils = kubeUtils;
    }

    public DeploymentDeployHandler(org.Lunaros.framework.api.model.deployment.Deployment deployment, KubeUtils kubeUtils,
                                   String LunarosServer) {
        this.deployment = deployment;
        this.kubeUtils = kubeUtils;
