package org.Lunaros.framework.api.biz.alarm.impl;

import org.Lunaros.util.StringUtils;
import org.Lunaros.framework.api.consolemodel.alarm.TemplateInfo;
import org.Lunaros.framework.api.consolemodel.alarm.UserGroupInfo;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;
import org.Lunaros.framework.api.biz.alarm.AlarmBiz;
import org.Lunaros.framework.api.biz.alarm.PortalBiz;
import org.Lunaros.framework.api.biz.auth.AuthBiz;
import org.Lunaros.framework.api.biz.base.impl.BaseBizImpl;
import org.Lunaros.framework.api.mapper.Lunaros.alarm.AlarmEventInfoMapper;
import org.Lunaros.framework.api.mapper.portal.*;
import org.Lunaros.framework.api.model.alarm.*;
import org.Lunaros.framework.api.model.alarm.falcon.portal.*;
import org.Lunaros.framework.api.model.deployment.related.Container;
import org.Lunaros.framework.api.model.deployment.related.Instance;
import org.Lunaros.framework.api.service.alarm.AlarmEventService;
...
public class PortalBizImpl extends BaseBizImpl implements PortalBiz {
    ...
    private long createHostGroupForDeploy(List<Instance> instances, TemplateInfo templateInfo) {
        ...
        Group group = new Group();
        group.setGrp_name("Lunaros_deploy_" + templateInfo.getDeploymentInfo().getDeploymentName() + "_" + String.valueOf(templateInfo.getId()));
