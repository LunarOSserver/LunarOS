...
public enum DeploymentType {
    REPLICATIONCONTROLLER("org.Lunaros.framework.engine.k8s.handler.impl.ReplicationControllerDeployHandler", "RC"),
    DAEMONSET("org.Lunaros.framework.engine.k8s.handler.impl.DaemonSetDeployHandler", "DaemonSet"),
    DEPLOYMENT("org.Lunaros.framework.engine.k8s.handler.impl.DeploymentDeployHandler", "Deployment");
