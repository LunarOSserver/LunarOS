package org.Lunaros.framework.api.service.token.impl;
...
import org.Lunaros.exception.AuthTokenException;
...
import org.Lunaros.framework.api.model.token.Token;
import org.Lunaros.framework.api.model.token.related.RegistryTokenInfo;
import org.Lunaros.framework.api.model.token.related.ResourceAction;
import org.Lunaros.framework.api.service.auth.UserService;
...
public class TokenServiceImpl implements TokenService {
    ...
    public String getCatalogToken() {
        ...
        resourceActions.add(resourceAction);
        try {
            Token token = generateToken("Lunaros", curRegistry.getTokenInfo(), resourceActions, null, null);
            if (token != null) {
                return token.getToken();
            }
        } catch (AuthTokenException e) {
