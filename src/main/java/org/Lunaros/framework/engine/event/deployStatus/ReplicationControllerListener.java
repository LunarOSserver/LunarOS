...
import org.Lunaros.framework.engine.event.UpdateDeployStatusTask;
import org.Lunaros.framework.engine.event.k8sEvent.K8sEventDetail;
import org.Lunaros.framework.engine.event.k8sEvent.K8sReplicationControllerEvent;
...
public class ReplicationControllerListener extends SimpleEventListener<K8sReplicationControllerEvent> implements UpdateDeployStatusTask {
    ...
    public void onEvent(K8sReplicationControllerEvent k8sReplicationControllerEvent) {
        // LunarOS create rc in k8s for this deployment, update deployment status here
